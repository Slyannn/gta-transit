...
import { createEnlevementEmailTemplate } from '../email-templates/enlevement-template';
...
export async function POST(request: NextRequest) {
  try {
    ...
    // Utiliser le template professionnel pour l'enlèvement
    const { html: htmlContent, text: textContent } = createEnlevementEmailTemplate(formData);
    ...
    console.error('Erreur lors de l\'envoi de l\'email d\'enlèvement:', error);
    return NextResponse.json(
